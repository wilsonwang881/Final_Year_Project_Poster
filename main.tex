...
The application can have multiple renderer processes but only have one main process. Each process corresponds to one F\# project.
    }
...
The above shows the main window and the below shows the window for creating basic logic blocks:
